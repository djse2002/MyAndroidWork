...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        });  // end btnGeoCoder1.setOnclickListener
        ...
        }); // end btnGeoCoder2.setOnclickListener

        btnMap1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // 위도, 경도 입력 후 지도 버튼 클릭 -> 지도 앱 화면으로 묵시적 인텐트 날린다.
            ...
            public void onClick(View v) {
                ...
                if(list != null){
                    if(list.size() ==0){
                        ...
                        String uri = String.format("geo:%f", lat,lng);
        ...
        }); // end btnMap2.setOnclickListener
