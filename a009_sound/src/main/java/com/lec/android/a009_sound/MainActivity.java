...
public class MainActivity extends AppCompatActivity {
    ...
    btnPlay1.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            // 음향 재생
            sp.play(soundId[0],    // 준비한 soudn 리소스 id
                    1,   // 왼쪽 볼륨 floot 0.0 ~ 1.0
                    2,  // 오른쪽 볼륨 float
                    0,      // 우선순위 int
                    0,        // 반복회수 int, 0:반복안함 , -1 : 무한 반복
        ...
        btnPlay2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 음향 재생
                sp.play(soundId[1],    // 준비한 soudn 리소스 id
                        1,   // 왼쪽 볼륨 floot 0.0 ~ 1.0
                        0,  // 오른쪽 볼륨 float
                        0,      // 우선순위 int
                        2,        // 반복회수 int, 0:반복안함 , -1 : 무한 반복
        ...
        btnPlay3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 음향 재생
                sp.play(soundId[2],    // 준비한 soudn 리소스 id
                        0,   // 왼쪽 볼륨 floot 0.0 ~ 1.0
                        1,  // 오른쪽 볼륨 float
                        0,      // 우선순위 int
                        -1,        // 반복회수 int, 0:반복안함 , -1 : 무한 반복
