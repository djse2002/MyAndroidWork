    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDlgEvent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ivDlgBanner.setImageResource(R.drawable.face15);
        ...
        dlg1.setCanceledOnTouchOutside(true);   // 다이얼로그 바깥 영역 클릭시
                                                // (혹은 back 버튼 클릭시) hide() 상태가 됨.
                                                // 종료 할 것인지 여부 체크, true : 종료, false : 종료 안됨.
