...
public class PhonebookAdapter extends RecyclerView.Adapter<PhonebookAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        // 준비된 레이아웃(XML) 으로 부터 View 를 만들어 ViewGroup 에 붙이고
        // 그렇게 만들어지 View 를 리턴한다.
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {   //item 레이아웃의 view 객체가 전달됨.
            ...
            swOnOff.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {  // 값이 변경 되었을때.
                    if(isChecked){
            ...
            btnDelItem.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   // position 정보 필요하다????
                    ...
                    // 데이터 변경 (수정, 삭제, 추가) 내역이 adapter 에 반영 되어야 정상적으로 동작함!!!! ★
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //Toast.makeText(v.getContext(),"postion:" + position, Toast.LENGTH_LONG).show();  // 하단에 숫자
